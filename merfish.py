...
plot.Quantification.plot(data, d_curve, C_curve, 'Closeness centrality', './figures/merfish/quantification/closeness.svg')
...
plot.Quantification.plot(data, d_curve, C_curve, 'Pagerank centrality', './figures/merfish/quantification/pagerank.svg')
