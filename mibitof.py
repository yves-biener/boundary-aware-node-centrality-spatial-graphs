...
plot.Graph.plot(G, pos, edges, corrected_closeness, 'Mibitof with corrected closeness centrality', './figures/mibitof/spatial_graph_corrected.svg')
# corrected relationship
corrected_data = plot.Quantification.data(pos, corrected_closeness)
plot.Quantification.plot(corrected_data, None, None, 'Corrected closeness centrality', './figures/mibitof/quantification/closeness_corrected.svg')
