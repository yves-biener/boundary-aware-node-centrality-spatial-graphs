...
plot.Quantification.plot(data, None, None, 'Pagerank centrality', './figures/mibitof/quantification/pagerank.svg')
d = data[:, 0]
C = data[:, 1]
m_opt, c0_opt, b_opt = quantification.fit_piece_wise_linear(d, C)
...
plot.Quantification.plot(data, d_curve, C_curve, 'Pagerank centrality', './figures/mibitof/quantification/pagerank_fitted.svg')
